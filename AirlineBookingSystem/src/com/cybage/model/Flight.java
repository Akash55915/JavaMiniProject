...
public String toString() {
	return "Flight [flight_No=" + flight_No + ", flight_total_no_seats=" + flight_total_no_seats
			+ ", flight_avaliable_seats=" + flight_avaliable_seats + ", flight_price=" + flight_price + ", flight_name="
			+ flight_name + ", flight_source=" + flight_source + ", flight_destination=" + flight_destination
			+ ", flight_type=" + flight_type + ", flight_time=" + flight_time + ", flight_date=" + flight_date + "]";
}
