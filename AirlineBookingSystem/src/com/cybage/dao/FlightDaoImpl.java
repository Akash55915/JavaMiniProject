...
public class FlightDaoImpl  implements FlightDao{
	...
	public Flight getFlightById(int flight_No) {
		Connection connection=JDBCUtility.getConncetion();
          ...
          Flight flight=null;
			   try {
				PreparedStatement preparedStatement=  connection.prepareStatement(" select *from flight where flight_No=?;");
			     ...
			     while(resultSet.next()) {
			       ...
			       flight=new Flight(flight_No1, flight_total_no_seats, flight_avaliable_seats, flight_price, flight_name, flight_source, flight_destination, flight_type, flight_time, flight_date) ;	 
